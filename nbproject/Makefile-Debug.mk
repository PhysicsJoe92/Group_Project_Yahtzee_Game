...
${OBJECTDIR}/src/AdminPlayer.o: src/AdminPlayer.cpp
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/AdminPlayer.o src/AdminPlayer.cpp
...
${OBJECTDIR}/src/SHA1.o: src/SHA1.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SHA1.o src/SHA1.cpp

${OBJECTDIR}/src/SHA256.o: src/SHA256.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SHA256.o src/SHA256.cpp

${OBJECTDIR}/src/Scanner.o: src/Scanner.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Scanner.o src/Scanner.cpp
